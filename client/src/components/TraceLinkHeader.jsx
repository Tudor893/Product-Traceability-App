...
const TraceLinkHeader = ({backPath}) => {
    const navigate = useNavigate()

    return (
        <div className="d-flex flex-row justify-content-between p-3 fs-4 ms-2">
            <div className="d-flex align-items-center" style={{cursor: 'pointer'}} onClick={() => navigate('/')}>
                ...
                <Button className="border-0 text-black me-3 fw-semibold" style={{backgroundColor: 'white', fontSize: '0.8em'}} onClick={() => navigate(backPath)}>
...
export default TraceLinkHeader